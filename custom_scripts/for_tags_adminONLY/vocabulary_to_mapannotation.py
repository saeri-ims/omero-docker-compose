...
client = scripts.client(
    "tags_to_map_annotation.py",
    ("Customised script for comparing tags from tag list and tags from imported csv and add matching rows to key-value pairs"),
...
tags_namespace = "kvpairs.from.tags.per.selected.images"
