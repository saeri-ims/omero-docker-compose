...
client = scripts.client(
    ...
    scripts.String("Prefix", grouping="3", default=""),
    scripts.String("Postfix", grouping="4", default=""),
    scripts.String("Old_Text", grouping="5", default=""),
    scripts.String("New_Text", grouping="6", default=""),
)
